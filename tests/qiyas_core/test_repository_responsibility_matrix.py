...
class TestRec1FreezeEnforcedInWorkingTree:
    ...
    def test_REC1_FREEZE_04_no_registry_builder_advances_p1_beyond_specified(self):
        ...
        carveouts: dict[str, set] = {
            ...
            # SCG-P5 builds on P4 (and thus the full P1 chain) — same P1 set.
            "build_p5_implemented_registry": {LETTER, HARAKA, CTS, POSITION, SLOT},
            # SCG-P6 builds on P5 (and thus the full P1 chain) — same P1 set.
            "build_p6_implemented_registry": {LETTER, HARAKA, CTS, POSITION, SLOT},
            # SCG-P7 builds on P6 (and thus the full P1 chain) — same P1 set.
            "build_p7_implemented_registry": {LETTER, HARAKA, CTS, POSITION, SLOT},
            # SCG-P8 builds on P7 (and thus the full P1 chain) — same P1 set.
            "build_p8_implemented_registry": {LETTER, HARAKA, CTS, POSITION, SLOT},
            # SCG-P9 builds on P8 (and thus the full P1 chain) — same P1 set.
            "build_p9_implemented_registry": {LETTER, HARAKA, CTS, POSITION, SLOT},
            # SCG-P10 builds on P9 (and thus the full P1 chain) — same P1 set.
            "build_p10_implemented_registry": {LETTER, HARAKA, CTS, POSITION, SLOT},
            # SCG-P11 builds on P10 (and thus the full P1 chain) — same P1 set.
            "build_p11_implemented_registry": {LETTER, HARAKA, CTS, POSITION, SLOT},
            # SCG-P12 (terminal) builds on P11 (and thus the full P1 chain) — same P1 set.
            "build_p12_implemented_registry": {LETTER, HARAKA, CTS, POSITION, SLOT},
        }
        builders = [
            (name, value)
